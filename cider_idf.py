...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='/home/xilini/par-gen/01-par-gen/data/dataset_paragraphs_v1.json', help='input json file to process into hdf5')
    parser.add_argument('--dict_json', default='/home/xilini/par-gen/01-par-gen/data/idx2word.json', help='output json file')
    parser.add_argument('--output_pkl', default='/home/xilini/par-gen/01-par-gen/data/vg-all', help='output pickle file')

...
We deliberately chose to re-implement an existing model to study the effects of using different modalities (visual or language).
...
We also measure lexical diversity of sentences within the generated paragraphs.
...
% SD 2020-07-09 16:11:33 +0200: The diversity should be **lagom** not too little diverse and not overly divserse given human-generated descriptions.
 ...
 \textbf{IMG+LNG+ATT} : \textit{There is a parking meter on a sidewalk. There are cars next to the street. There is a parking lot next to the street.} }
    ...
    \begin{subfigure}[t]{.49\textwidth}
        \centering
         \fbox{\includegraphics[width=2.88in,height=2.22in]{figures/example3}}
         \begin{addmargin}[0em]{.5em}
        \caption{
        \baselineskip=1.29\baselineskip
...
Note that humans mostly judge models that incorporate linguistic information as the best ones for the word choice criterion.

...
% best beam for accuracy = 2, best beam for diversity =?
% best scores for accuracy = with min length, best scores for diversity - without min length
% test min length parameter

% also, briefly write about sampling sentence from beam search - we take the one which is most likely now, but other sentences might be even better
